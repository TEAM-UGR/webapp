...
describe("Integration Test 1 for creating a user and validating using GET", () => {
  test("POST /v2/user - success - Create User", async () => {
    const req = {
      first_name: "Rohan",
      last_name: "Biradar",
      password: "Asb@1999",
    ...
    const responsePOST = await request(app).post("/v2/user").send(req);
...
describe("Integration Test 2 for Updating a user and Validating using GET", () => {
  test("PUT /v2/user/self - success - Update User", async () => {
    const username = "123456@mail.com";
